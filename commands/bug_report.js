...
module.exports = {
  ...
  execute: async (Client, msg, args) => {
    ...
    if(args.length > 1024) return await Client.createMessage(msg.channel.id, `Your bug report is too long.`)
    ...
    await Client.createMessage(config.bug_report_channel, { embed: {
      ...
      return await msg.channel.createMessage(`:wrench: Bug report sent! If the developer has any questions regarding your bug report, this bot will DM you the developer's question/message, so be sure to allow DMs from people within the guild.`)
    })
  }
}
