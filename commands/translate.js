...
module.exports = {
  ...
  execute:async function(bot, msg, args){
    if(args[0] == undefined || args[0] == null || args[0] == "") return msg.channel.createMessage("No language specified!");
    var thingToTranslate = args.join(" ").replace(args[0], "");
    switch(args[0].toString().toLowerCase()){
      ...
      case "azerbaijani": return translateFunction(args[0].toLowerCase().substring(0, 2), thingToTranslate, ':flag_az:');
      case "basque": return translateFunction("eu", thingToTranslate, ':flag_fr:');
      case "belarusian": return translateFunction(args[0].toLowerCase().substring(0, 2), thingToTranslate, ':flag_by:');
      ...
      case "catalan": return translateFunction(args[0].toLowerCase().substring(0, 2), thingToTranslate, ':flag_ad:');
      case "cebuano": return translateFunction(args[0].toLowerCase().substring(0, 3), thingToTranslate, ':flag_ph:');
      ...
      case "corsican": return translateFunction(args[0].toLowerCase().substring(0, 2), thingToTranslate, ':flag_it:');
      ...
      case "danish": return translateFunction(args[0].toLowerCase().substring(0, 2), thingToTranslate, ':flag_dk:');
      case "dutch": return translateFunction("nl", thingToTranslate, ':flag_nl:');
      case "english": return translateFunction(args[0].toLowerCase().substring(0, 2), thingToTranslate, ':flag_um:');
      ...
      case "finnish": return translateFunction(args[0].toLowerCase().substring(0, 2), thingToTranslate, ':flag_fi:');
      case "french": return translateFunction(args[0].toLowerCase().substring(0, 2), thingToTranslate, ':flag_fr:');
      ...
      case "gujarati": return translateFunction(args[0].toLowerCase().substring(0, 2), thingToTranslate, ':flag_in:');
      case "haitian": return translateFunction("ht", thingToTranslate, ':flag_ht:');
      case "hausa": return translateFunction(args[0].toLowerCase().substring(0, 2), thingToTranslate, ':flag_ne:');
      case "hawaiian": return translateFunction(args[0].toLowerCase().substring(0, 3), thingToTranslate, ':flag_um:');
      case "hebrew": return translateFunction("iw", thingToTranslate, ':flag_il:');
      case "hindi": return translateFunction(args[0].toLowerCase().substring(0, 2), thingToTranslate, ':flag_in:');
      case "hmong": return translateFunction("hmn", thingToTranslate, ':flag_cn:');
      case "hungarian": return translateFunction(args[0].toLowerCase().substring(0, 2), thingToTranslate, ':flag_hu:');
      case "icelandic": return translateFunction("is", thingToTranslate, ':flag_is:');
      case "igbo": return translateFunction(args[0].toLowerCase().substring(0, 2), thingToTranslate, ':flag_ng:');
      ...
      case "italian": return translateFunction(args[0].toLowerCase().substring(0, 2), thingToTranslate, ':flag_it:');
      case "japanese": return translateFunction(args[0].toLowerCase().substring(0, 2), thingToTranslate, ':flag_jp:');
      ...
      case "kurdish": return translateFunction(args[0].toLowerCase().substring(0, 2), thingToTranslate, ':flag_tr:');
      case "kyrgyz": return translateFunction(args[0].toLowerCase().substring(0, 2), thingToTranslate, ':flag_cn:');
      case "lao": return translateFunction("lo", thingToTranslate, ':flag_la:');
      case "latin": return translateFunction(args[0].toLowerCase().substring(0, 2), thingToTranslate, ':flag_va:');
